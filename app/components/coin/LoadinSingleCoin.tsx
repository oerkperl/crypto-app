      ...
      <Section>
        ...
        <div className="flex justiify-between gap-2 mt-4">
          <div className="w-2/6  min-h-16">
            <div className="w-full h-52 bg-white dark:bg-gray-700 rounded-xl flex flex-col items-center justify-center gap-4">
          ...
          <div className="w-2/6  min-h-16">
            <div className="w-full h-52 bg-white dark:bg-gray-700 rounded-xl flex flex-col justify-center gap-4 p-2">
              <BlinkingGradientLoader width="200px" />
        ...
        <div className="w-full py-6 px-2 mt-4 bg-white dark:bg-gray-700 rounded-xl p-2 max-h-52 flex flex-col gap-3">
        ...
        <div className="w-full py-4 px-2 mt-4 bg-white dark:bg-gray-700 rounded-xl">
