...
// import { usePortfolioStore, TAsset } from "@/store/portfolioStore";
...
//   // ✅ Zustand: Selective subscriptions to portfolio store
...
//     if (inputValue < 0) {
//       setNotification("Negative input not allowed");
//     } else {
...
//       <section>
//         <div className="w-full min-h-[40vh] p-4 sm:p-6">
...
//                   )}
//                   <button
//                     className="w-8 h-8 rounded-full shadow-md bg-gray-100 dark:bg-gray-700 hover:bg-indigo-600 hover:text-white transition-colors flex items-center justify-center"
//                     onClick={onClose}
//                   >
//                     ×
//                   </button>
...
//                     <div
//                       className={`min-h-[44px] w-full shadow-md bg-white dark:bg-gray-700 rounded flex items-center overflow-hidden
//                       ${
//                         !hasCoin && wantsToSave
...
//                     <input
//                       className={`min-h-[44px] w-full shadow-md rounded px-3 bg-white dark:bg-gray-700 outline-none text-base
//                       ${
...
//                   <div className="h-16 w-16 sm:h-20 sm:w-20 flex items-center justify-center rounded-md bg-gray-300 dark:bg-gray-900 overflow-hidden">
//                     <Image
//                       src={
//                         selectedCoin?.image ||
...
//                       height={60}
//                       width={60}
//                       className="w-12 h-12 sm:w-[70px] sm:h-[70px] object-contain"
//                       alt="coin image"
//                     />
//                   </div>
//                   <div className="flex flex-col items-center text-center">
//                     <p className="text-sm sm:text-base font-medium truncate max-w-full">
